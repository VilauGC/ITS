...
# f.write(pickle.dumps(r))
# f.close()
f = open("C:\\1.workspace_vilau\\MASTER STI\\0.Disertatie\\ITS_PY\\RootCA\\secp256r1pubkeyRCA.txt", 'wb')
f.write(pickle.dumps(V))
f.close()

f = open("C:\\1.workspace_vilau\\MASTER STI\\0.Disertatie\\ITS_PY\\RootCA\\secp256r1privkeyRCA.txt", 'wb')
f.write(pickle.dumps(r))
f.close()
